<x-app-layout>
    ...
    <div class="mb-6 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 text-white">
        ...
        <p class="text-indigo-200 mt-1">Here's what's happening in your business today.</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-green-600 mt-1">0 transactions</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-blue-600 mt-1">0 low stock</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">0</p>
                <p class="text-xs text-yellow-600 mt-1">0 new this month</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">$0.00</p>
                <p class="text-xs text-red-600 mt-1">vs last month</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">0</p>
                <p class="text-xs text-indigo-600 mt-1">0 active</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">0</p>
                <p class="text-xs text-teal-600 mt-1">0 on leave</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">$0.00</p>
                <p class="text-xs text-pink-600 mt-1">0 processed</p>
            </div>
        </div>
